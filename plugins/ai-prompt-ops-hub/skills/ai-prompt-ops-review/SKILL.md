---
name: ai-prompt-ops-review
description: Review prompt templates, evaluation cases, and operator procedures for quality and gaps. Use when changes in ai prompt ops need a fast, structured pass.
version: 1.0.0
---

# AI Prompt Ops Review

Run a focused review of prompt templates, evaluation cases, and operator procedures.
