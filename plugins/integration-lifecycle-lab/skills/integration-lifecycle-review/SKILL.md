---
name: integration-lifecycle-review
description: Review integration contracts, launch steps, and dependency boundaries for quality and gaps. Use when changes in integration lifecycle need a fast, structured pass.
version: 1.0.0
---

# Integration Lifecycle Review

Run a focused review of integration contracts, launch steps, and dependency boundaries.
