...
description: Review developer docs, setup flows, and common local tasks for quality and gaps. Use when changes in developer experience need a fast, structured pass.
version: 1.0.0
---

# Developer Experience Review

Run a focused review of developer docs, setup flows, and common local tasks.
