---
name: billing-operations-review
description: Review billing events, invoices, and operational handoffs for quality and gaps. Use when changes in billing operations need a fast, structured pass.
version: 1.0.0
---

# Billing Operations Review

Run a focused review of billing events, invoices, and operational handoffs.
